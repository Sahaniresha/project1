            ...
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/project-1.jpg" alt="project-1">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/project-2.jpg" alt="project-2">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/project-3.jpg" alt="project-3">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/project-4.jpg" alt="project-4">
