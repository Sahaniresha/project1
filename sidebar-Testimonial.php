        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/testimonial-1.jpg" alt="testimonial-1">
                ...
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/testimonial-2.jpg" alt="testimonial-2">
                ...
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/testimonial-3.jpg" alt="testimonial-3">
                ...
                <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/testimonial-4.jpg" alt="testimonial-4">
